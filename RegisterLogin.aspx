            ...
            <div class="max-w-md mx-auto bg-white p-8 rounded-xl shadow-md">
                <div class="flex gap-4 mb-8">
                    <asp:Button ID="btnLoginTab" runat="server" Text="Sign In" 
                        CssClass="flex-1 font-space py-2 rounded-lg bg-[#f0f0f0] text-gray-500" />
                    <asp:Button ID="btnRegisterTab" runat="server" Text="Sign Up" 
                        CssClass="flex-1 font-space py-2 rounded-lg bg-[#57a4ff] text-black" />
                </div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <asp:Label CssClass="text-sm text-gray-600 block mb-2" runat="server">Password</asp:Label>
